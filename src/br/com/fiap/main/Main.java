...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.printf("Dados Fornecidos:\nRenda Familiar Bruta: %.3f\nNúmero de moradores da casa: %d\nGasto mensal da casa com luz: %f.3f\nGasto mensal da casa com internet: %f.3f\nGasto mensal da casa com academia: %f.3f\n Total em gastos mensais: %f.3f\nRenda Familiar Líquida: %f.3f", novoCalculo.rendaFamiliar, novoCalculo.numeroDeMoradores, novoCalculo.gastoComLuz, novoCalculo.gastoComInternet, novoCalculo.valorMensalidadeDaAcademia, novoCalculo.calcularTotalDeDespesas(), novoCalculo.calcularRendaFamiliarLiquida());
        } catch (Exception e){
